...
#define floatCompare(x, y) \
	...
	inline uint32_t FloatAbsBits(float f)
	{
	...
	{
		out[0][0] = BitsToFloat(FloatAbsBits(in[0][0]));
		out[0][1] = BitsToFloat(FloatAbsBits(in[0][1]));
		out[0][2] = BitsToFloat(FloatAbsBits(in[0][2]));
		out[1][0] = BitsToFloat(FloatAbsBits(in[1][0]));
		out[1][1] = BitsToFloat(FloatAbsBits(in[1][1]));
		out[1][2] = BitsToFloat(FloatAbsBits(in[1][2]));
		out[2][0] = BitsToFloat(FloatAbsBits(in[2][0]));
		out[2][1] = BitsToFloat(FloatAbsBits(in[2][1]));
		out[2][2] = BitsToFloat(FloatAbsBits(in[2][2]));
	}
