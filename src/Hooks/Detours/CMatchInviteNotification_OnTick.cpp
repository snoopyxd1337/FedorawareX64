...
MAKE_HOOK(CMatchInviteNotification_OnTick, S::CMatchInviteNotification_OnTick(), void, __fastcall, void* ecx)
{
	...
	{
		*reinterpret_cast<double*>(reinterpret_cast<uintptr_t>(ecx) + 424) = 0.0;
		// v3 = *(double*)(this + 424);
