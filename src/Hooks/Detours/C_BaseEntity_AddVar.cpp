...
MAKE_HOOK(C_BaseEntity_AddVar, S::C_BaseEntity_AddVar(), void, __fastcall, void* ecx, void* data, IInterpolatedVar* watcher, int type, bool bSetup) {
	...
	return Hook.Original<FN>()(ecx, data, watcher, type, bSetup);
}
