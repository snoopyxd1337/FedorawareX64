...
MAKE_HOOK(CEconItemSchema_GetItemDefinition, S::CEconItemSchema_GetItemDefinition(), CEconItemDefinition_t*, __fastcall, void* ecx, int iItemIndex)
{
	const auto pItemDefinition = Hook.Original<FN>()(ecx, iItemIndex);
