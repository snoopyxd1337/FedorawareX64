...
namespace S
{
	MAKE_SIGNATURE(CCollisionProperty_SetCollisionBounds, CLIENT_DLL, "48 89 5C 24 ? 48 89 74 24 ? 48 89 7C 24 ? 41 56 48 81 EC ? ? ? ? F3 0F 10 0A", 0x0);
	MAKE_SIGNATURE(CCollisionProperty_CalcNearestPoint, CLIENT_DLL, "48 89 5C 24 ? 57 48 83 EC ? 49 8B D8 48 8B F9 4C 8D 44 24", 0x0);
}
...
// Modern TF2 x64 handle layout used by Amalgam.
#undef NUM_ENT_ENTRY_BITS
#undef NUM_ENT_ENTRIES
#undef NUM_SERIAL_NUM_BITS
#undef ENT_ENTRY_MASK
...
#ifndef NUM_SERIAL_NUM_SHIFT_BITS
#define NUM_SERIAL_NUM_SHIFT_BITS NUM_ENT_ENTRY_BITS
#endif
...
public:
	__inline void SetCollisionBounds(const Vec3& mins, const Vec3& maxs)
	{
		...
		static auto func = S::CCollisionProperty_SetCollisionBounds.As<FN>();
		func(this, mins, maxs);
	}
