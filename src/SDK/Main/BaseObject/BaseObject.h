...
public: //Netvars
	M_DYNVARGET(Controlled, bool, this, "DT_ObjectSentrygun", "m_bPlayerControlled")
		...
		M_DYNVARGET(hBuilder, EHANDLE, this, "DT_BaseObject", "m_hBuilder")
...
public: //Everything else, lol
	...
	{
		DYNVAR(hBuilder, EHANDLE, "DT_BaseObject", "m_hBuilder");
		return I::ClientEntityList->GetClientEntityFromHandleSafe(hBuilder.GetValue(this));
	}
