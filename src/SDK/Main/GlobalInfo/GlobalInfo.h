...
namespace G
{
	...
	inline std::string AimbotDebugStage = "startup";
	inline std::string AimbotDebugReason = "startup";
	inline std::string TriggerDebugReason = "startup";
	inline bool DebugSendPacket = true;
	inline bool DebugAttackButton = false;
	inline float DebugCurTime = 0.f;
	inline float DebugNextPrimaryAttack = 0.f;
	inline float DebugNextSecondaryAttack = 0.f;
	inline float DebugNextAttack = 0.f;
